...
const Navbar = () => {
    ...
    const user: any = {name: 'Divyanshu', email: 'divcroot@gmail.com', isAdmin: true}
                    ...
                    <div className="relative">
                        {user ? (
                            <button onClick={() => setUserMenuOpen(!userMenuOpen)} className="flex items-center gap-2 p-2">
                                <div className="size-7 rounded-full flex-center bg-green-950 text-white">
                            ...
                            <div className="flex-center gap-2">
                                <Link to='/login' className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-900-light transition-colors">
                            ...
                            <>
                                ...
                                <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                                    ...
                                    <div onClick={() => setUserMenuOpen(false)}>
                                        ...
                                        {user?.isAdmin && (
                                            <Link to='/admin/products' className="dropdown-link"><ShieldIcon className="text-app-orange-dark" size={16}/><span className="text-app-orange-dark">Admin Pannel</span>
                                            </Link>
                                        )}
