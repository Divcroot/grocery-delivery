      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animate-slide-in-right">
            ...
            items.map((item) => (
              <div key={item.product._id} className="flex gap-3 bg-app-cream/60 rounded-xl p-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-app-text-light">{item.product.price.toFixed(2)} / {item.product.unit}</p>
        ...
        {items.length > 0 && (
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            {deliveryFee > 0 && <p className="text-xs text-app-text-light text-center">Free delivery on orders above {currency}20!</p>}
            ...
            <div className="flex justify-between text-base font-semibold border-t border-app-border pt-3">
              ...
              <span className="font-medium">{currency}{grandTotal.toFixed(2)}</span>
            </div>
